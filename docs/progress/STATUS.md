...
### M07 Task 4 original TDD evidence
...
- Corrected genuine test-only RED: `49f423bcbdfd1458be31b4e376c55ef269e32a39`; CI `33796054973`: PHPCS clean; PHPStan **No errors**; PHPUnit **280 tests / 1334 assertions / 2 intended failures**.
...
5. bounded termination/performance on long descriptor sequences;
