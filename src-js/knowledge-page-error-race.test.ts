...
describe( 'knowledge page request error ordering', () => {
	afterEach( () => {
	...
	it( 'ignores an older page failure after a newer page succeeds', async () => {
		let rejectPageOne: ( reason?: unknown ) => void = () => undefined;
