...
/** Adds normalized display-rule JSON storage to existing bot configurations. */
final class V013AddBotDisplayRules implements Migration {
	/**
	...
	/**
	 * Add nullable display-rule JSON storage through WordPress dbDelta.
	 *
	 * Existing bot rows intentionally migrate with null display rules so the
	 * repository can project deterministic M15 defaults.
	 *
