<?php
/**
 * Real WordPress administrator M13 REST smoke assertions.
 *
...
try {
	...
	$cleanup();
	fwrite( STDOUT, "WordPress M13 administrator REST smoke passed.\n" );
} catch ( Throwable $exception ) {
	$fail( 'WordPress M13 administrator REST smoke threw: ' . $exception->getMessage() );
}
