...
required=(
    ...
    "wp-rag-ai-chatbot/build/widget.js"
    "wp-rag-ai-chatbot/build/chatbot-block.js"
    "wp-rag-ai-chatbot/assets/widget.css"
    "wp-rag-ai-chatbot/blocks/chatbot/block.json"
